...
public partial class ReportSalesMaterialSummaryByReasonBookBuyAdmin
{
    ...
    public double? PriceImpOrderBuy { get; set; }

    public double? QuantityImpOrderBuy { get; set; }

    public decimal? AmountOfMoneyImpOrderBuy { get; set; }

    public double? PriceImpOffer { get; set; }

    public double? QuantityImpOffer { get; set; }

    public decimal? AmountOfMoneyImpOffer { get; set; }
    ...
    public double? PriceExpOrderSell { get; set; }

    public double? QuantityExpOrderSell { get; set; }

    public decimal? AmountOfMoneyExpOrderSell { get; set; }

    public double? PriceExpOffer { get; set; }

    public double? QuantityExpOffer { get; set; }

    public decimal? AmountOfMoneyExpOffer { get; set; }
