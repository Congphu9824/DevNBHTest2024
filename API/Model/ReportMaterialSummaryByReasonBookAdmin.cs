...
public partial class ReportMaterialSummaryByReasonBookAdmin
{
    ...
    public decimal? AmountOfMoneyBegin15 { get; set; }
    ...
    public decimal? AmountOfMoneyImp15 { get; set; }

    public double? PriceImpBuy { get; set; }

    public double? QuantityImpBuy { get; set; }

    public double? QuantityImp15Buy { get; set; }

    public decimal? AmountOfMoneyImpBuy { get; set; }

    public decimal? AmountOfMoneyImp15Buy { get; set; }

    public double? PriceImpBorrowing { get; set; }

    public double? QuantityImpBorrowing { get; set; }

    public double? QuantityImp15Borrowing { get; set; }

    public decimal? AmountOfMoneyImpBorrowing { get; set; }

    public decimal? AmountOfMoneyImp15Borrowing { get; set; }

    public double? PriceImpTransfer { get; set; }

    public double? QuantityImpTransfer { get; set; }

    public double? QuantityImp15Transfer { get; set; }

    public decimal? AmountOfMoneyImpTransfer { get; set; }

    public decimal? AmountOfMoneyImp15Transfer { get; set; }

    public double? PriceImpInventory { get; set; }

    public double? QuantityImpInventory { get; set; }

    public double? QuantityImp15Inventory { get; set; }

    public decimal? AmountOfMoneyImpInventory { get; set; }

    public decimal? AmountOfMoneyImp15Inventory { get; set; }

    public double? PriceImpAnother { get; set; }

    public double? QuantityImpAnother { get; set; }

    public double? QuantityImp15Another { get; set; }

    public decimal? AmountOfMoneyImpAnother { get; set; }

    public decimal? AmountOfMoneyImp15Another { get; set; }
    ...
    public decimal? AmountOfMoneyEnd15 { get; set; }
