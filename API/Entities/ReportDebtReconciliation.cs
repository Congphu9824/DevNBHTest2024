...
public partial class ReportDebtReconciliation
{
    ...
    public decimal? AmountOfMoneyExpRe { get; set; }

    public decimal? AmountOfMoneyAbate { get; set; }

    public decimal? AmountOfMoneyAdjust { get; set; }

    public decimal? AmountOfMoneyother { get; set; }
