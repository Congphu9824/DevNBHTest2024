...
public partial class ReportMaterialSummaryBookAdmin
{
    ...
    public int? PackageQuantityBegin { get; set; }
    ...
    public int? PackageQuantityImp { get; set; }
    ...
    public int? PackageQuantityExp { get; set; }
    ...
    public int? PackageQuantityEnd { get; set; }
